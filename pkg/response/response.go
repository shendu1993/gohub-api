...
func Success(c *gin.Context) {
	JSON(c, gin.H{
		"code":    StatusSuccess,
		"message": locale.Translate(c, "success"),
	})
}
...
func Abort404(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusNotFound, gin.H{
		"message": defaultMessage(locale.Translate(c, "404_default_message"), msg...),
	})
}
func Abort403(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusForbidden, gin.H{
		"message": defaultMessage(locale.Translate(c, "403_default_message"), msg...),
	})
}
...
func Abort500(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusInternalServerError, gin.H{
		"message": defaultMessage(locale.Translate(c, "500_default_message"), msg...),
	})
}

//BadRequest 响应400 传参err对象，为传参msg时使用默认消息
//再解析用户请求，请求的格式或者方法不霍夫预期的时候调用
...
func Error(c *gin.Context, err error, msg ...string) {
	...
	c.AbortWithStatusJSON(http.StatusUnprocessableEntity, gin.H{
		"message": defaultMessage(locale.Translate(c, "422_default_message"), msg...),
		"error":   err.Error(),
	})
}
...
func ValidationError(c *gin.Context, errors map[string][]string) {
	c.AbortWithStatusJSON(http.StatusUnprocessableEntity, gin.H{
		"message": locale.Translate(c, "validationError_default_message"),
		"errors":  errors,
	})
}
...
func Unauthorized(c *gin.Context, msg ...string) {
	c.AbortWithStatusJSON(http.StatusUnauthorized, gin.H{
		"message": defaultMessage(locale.Translate(c, "401_default_message"), msg...),
	})
}
