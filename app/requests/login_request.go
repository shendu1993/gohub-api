...
import (
	"gohub-api/app/requests/validators"
...
type LoginByPhonePasswordRequest struct {
...
func LoginByPhonePassword(data interface{}, c *gin.Context) map[string][]string {
	rules := govalidator.MapData{
	...
	errs := validate(data, rules, messages)
	//图片验证码
	_data := data.(*LoginByPhonePasswordRequest)
